...
class downStep(nn.Module):
    def __init__(self, inC, outC):
        ...
        self.conv1 = nn.Conv2d(in_channels = inC, out_channels = outC, kernel_size = 3)
        self.relu = nn.ReLU()
        self.conv2 = nn.Conv2d(in_channels = outC, out_channels = outC, kernel_size = 3)
        self.bachnorm = nn.BatchNorm2d(num_features = outC)
...
class upStep(nn.Module):
    def __init__(self, inC, outC, withReLU=True):
        ...
        self.relu = nn.ReLU()
        self.conv2 = nn.Conv2d(in_channels = outC, out_channels = outC, kernel_size = 3)
        self.conv3 = nn.Conv2d(in_channels = outC , out_channels = 2, kernel_size = 1)
    ...
    def forward(self, x, x_down):
        ...
        x = self.deconv1(x)
        crop1 = self.center_crop(x_down , x.shape[2:])
